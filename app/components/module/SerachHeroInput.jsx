...
const SerachHeroInput = () => {
  return (
    <section className="block w-full relative max-md:h-[500px] h-[600px]  ">
      ...
      />
      <div className=" flex w-full p-4 left-0 pt-5 text-white  max-sm:h-[300px] h-[400px] justify-center m-auto  z-30  ">
        <div
          id="input-container"
          className="backdrop-blur-[2px] w-full  max-w-xl mt-10"
        >
          <h1 className="font-semibold max-sm:!text-2xl !text-4xl uppercase !mb-0">
            finde the perfect rental
          </h1>
          <p className="  font-semibold mb-4 uppercase">
            discover yor house
          </p>
          <Suspense>
            <Searching />
