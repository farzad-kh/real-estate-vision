    ...
    <div className="flex   gap-2  mb-6">
      ...
      >
        <Image
          ...
          height={600}
        />
     {propertyImg.length > 1 &&   <div className="absolute bottom-4 right-4 py-[6px] px-2 rounded bg-white text-sm inline-flex gap-2 items-center font-semibold"><SlPicture />
      show more</div>}
      </div>
      {propertyImg.length > 1 && (
